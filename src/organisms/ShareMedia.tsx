...
import ShareMediaStyles from '../styles/organisms/ShareMediaStyles';
  ...
  return (
    <>
      ...
      <ShareMediaStyles>
        ...
        <div>
          <a target="_blank" href={`https://www.linkedin.com/shareArticle?mini=true&url=https://ulisessg.com${path}`} rel="noreferrer">
            <img alt="Compartir en LinkedIn Logo" src="https://firebasestorage.googleapis.com/v0/b/web-projects-50e7e.appspot.com/o/images%2Fv2%2Fblogs%2Fshare%20social%20media%2FLinkedIn%20share%20logo.png?alt=media&token=0be89f71-48aa-46bd-9c36-82c0e6e355f3" width="80px" height="auto" />
